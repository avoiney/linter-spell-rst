  ...
  provideGrammar () {
    ...
    return [{
      ...
      checkedScopes: {
          ...
          'entity.name.directive.restructuredtext': false,
          ...
          'source.embedded.coffee': false,
          'source.embedded.js': false,
          'source.embedded.json': false,
          'source.embedded.css': false,
          'source.embedded.xml': false,
          'source.embedded.ruby': false,
          'source.embedded.java': false,
          'source.embedded.erlang': false,
          'source.embedded.cs': false,
          'source.embedded.php': false,
          'source.embedded.shell': false,
          'source.embedded.python': false,
          'source.embedded.objc': false,
          'source.embedded.yaml': false,
          'source.embedded.latex': false,
          'source.embedded.python': false,
          'source.embedded.c': false,
          'source.embedded.cpp': false,
